...
Si es una Transferencia extranjero se debe de establecer el Cdigo Estadístico para Transferencia Internacional (6 carácteres)

Nota: La exportación de fichero esta establecido a un código de divisa fijo en Euros.
Las Cuentas bancarias deben ser con formato IBAN.
